...
let zodResponseFormatFn: ((schema: any, name: string) => any) | null = null;
async function getZodResponseFormat(): Promise<((schema: any, name: string) => any) | null> {
  if (zodResponseFormatFn) return zodResponseFormatFn;
  try {
