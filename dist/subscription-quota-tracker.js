...
export class SubscriptionQuotaTracker {
     ...
     */
    async recordUsage(provider, tokens) {
        if (!this.initialized)
    ...
    canRetry(provider) {
        ...
        const failureIndex = Math.min(providerData.consecutiveFailures - 1, this.backoffSchedule.length - 1);
...
//# sourceMappingURL=subscription-quota-tracker.js.map